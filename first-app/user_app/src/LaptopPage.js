...
class LaptopPage extends Component{
    ...
    componentWillMount() {
        axios({
            method:'post',
            url:'https://api.shuttlescrap.com/laptop_data/get_single_laptop',
            data:{
                id:this.props.laptop_id
            }
        }).then((resp)=>{
            this.setState({
                data: resp.data
            ...
            return(
                ...
                <Card style={{flexDirection:'column'}}>
                    <CardSection style={{flexDirection:'column',padding:15}}>
                       <Text style={{fontSize:15,marginBottom:15,textAlign:'center',alignSelf:'center',color:'#22aa86'}}> Looking to sell this Laptop to Shuttlescrap?Get upto Rs.{show} from us!</Text>
...
export default connect(mapStateToProps,{laptopSelected})(LaptopPage);