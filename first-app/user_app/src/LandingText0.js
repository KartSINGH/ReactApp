...
class LandingPage extends Component{
    render(){
        ...
        <Image 
        resizeMode='stretch'
        source={require('../img/screen2-03-min.png')}
...
class LandingText0 extends Component {
   goLogin(){
      
      Actions.front_image_last()
    }
   state={
      backPress:false
    }
