...
class TabletPage extends Component{
    ...
    componentDidMount() {
        axios({
            method:'post',
            url:'https://api.shuttlescrap.com/tablets/get_single_tablets',
            data:{
                id:this.props.tablet_id
            }
        }).then((resp)=>{
            this.setState({
                data: resp.data
            ...
            return(
                ...
                <Card style={{flexDirection:'column'}}>
                    <CardSection style={{flexDirection:'column',padding:15}}>
                       <Text style={{fontSize:15,marginBottom:15,textAlign:'center',alignSelf:'center',color:'#22aa86'}}> Looking to sell this tablet to Shuttlescrap?Get upto Rs.{show} from us!</Text>
...
export default connect(mapStateToProps,{tabletSelected})(TabletPage);